...
@section('content')
    <!-- row -->
    {{-- top statistics --}}
    <div class="row row-sm" id="top-statistics">
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="tx-20 font-weight-bold mb-1 text-white">الأنواع</h6>
                    </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            ...
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white" id="genres-count" style="display: none">
                                </h4>

                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class=" text-white"></i>
                                <a class="mb-3 tx-12 text-white" href="{{ route('genres.index') }}">عرض ...</a>
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="tx-20 font-weight-bold mb-1 text-white">الأفلام</h6>
                    </div>
                    <div class="loader loader-sm"></div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white" id="movies-count" style="display: none;">
                                </h4>

                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class=" text-white"></i>
                                <a class="mb-3 tx-12 text-white" href="{{ route('movies.index') }}">عرض ...</a>
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="tx-20 font-weight-bold mb-1 text-white">الفنانين</h6>
                    </div>
                    <div class="loader loader-sm"></div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white" id="actors-count" style="display: none;">
                                </h4>

                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="text-white"></i>
                                <a class="mb-3 tx-12 text-white" href="{{ route('actors.index') }}">عرض ...</a>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex my-2">
                        <h4 class="mb-0">الأكثر شعبية</h4>
                        <a href="{{ route('movies.index') }}" class="mx-2 mt-1">عرض الكل</a>
                    </div>
                    ...
                    <table class="table">
                        ...
                        @foreach ($popularMovies as $index => $movie)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td><a href="{{ route('movies.show', $movie->id) }}">{{ $movie->title }}</a>
                                </td>
                    ...
                    <div class="d-flex my-2">
                        <h4 class="mb-0">الأكثر شغال الان</h4>
                        <a href="{{ route('movies.index', ['type' => 'now_playing']) }}" class="mx-2 mt-1">عرض
                            الكل</a>
                    </div>
                    ...
                    <div class="d-flex my-2">
                        <h4 class="mb-0">الأعلى يأتي قريبا</h4>
                        <a href="{{ route('movies.index', ['type' => 'upcoming']) }}" class="mx-2 mt-1">عرض الكل</a>
                    </div>
