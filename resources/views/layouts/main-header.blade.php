            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('assets/img/ali.jpg') }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt="" src="{{ URL::asset('assets/img/ali.jpg') }}"
                                        class=""></div>
                                <div class="mr-3 my-auto">
                                    <!-- تم جلب اسم المستخدم والايميل ووضعهم مكان الاسم الغير حقيقي  -->
                        ...
                        <!-- تم اضافته لعمل تسجيل خروج في القائمة المنسدلة في صفحة المشروع الرئيسية -->
