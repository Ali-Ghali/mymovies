...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">قائمة الفنانين</li>
    </ul>
            ...
            <div class="tile shadow">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="{{ route('actors.bulk_delete') }}" style="display: inline-block;">
                            @csrf
                            @method('delete')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="data-table-search" class="form-control" autofocus placeholder="ابحث">
                        </div>
                    </div>
